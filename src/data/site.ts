...
export const nav = [
  { label: 'ראשי', href: '/' },
  {
    ...
    children: [
      ...
      { label: 'פתיחת סתימה בצנרת', href: '/פתיחת-סתימה-בצנרת/' },
    ],
  },
  {
...
export const services = [
  ...
  { label: 'פתיחת סתימה בצנרת', href: '/פתיחת-סתימה-בצנרת/', icon: 'droplet', desc: 'סתימה עמוקה שמשפיעה על כמה כלים בבת אחת' },
