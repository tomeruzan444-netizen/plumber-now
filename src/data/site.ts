...
export const nav = [
  { label: 'ראשי', href: '/' },
  {
    ...
    children: [
      ...
      { label: 'פתיחת סתימה עם ספירלה חשמלית', href: '/פתיחת-סתימה-עם-ספירלה-חשמלית/' },
      { label: 'פתיחת סתימה במרזב', href: '/פתיחת-סתימה-במרזב/' },
    ],
  },
  {
...
export const services = [
  ...
  { label: 'פתיחת סתימה עם ספירלה חשמלית', href: '/פתיחת-סתימה-עם-ספירלה-חשמלית/', icon: 'wrench', desc: 'איך המכשיר עובד ומתי הוא הכלי הנכון' },
  { label: 'פתיחת סתימה במרזב', href: '/פתיחת-סתימה-במרזב/', icon: 'droplet', desc: 'מרזב שגולש בגשם - סימנים וטיפול' },
